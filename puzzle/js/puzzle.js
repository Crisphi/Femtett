...
const gameBoard = {
    ...
    init: function () {
        ...
        this.image.src = 'images/zoo_complet.png';
        this.image.style.maxWidth = "604px";
        this.image.style.maxHeight = "480px";
    },
    ...
    initSpaces: function () {
        this.boardSpace = new Rectangle(0, 15, Math.max(this.canvas.width, this.MAX_PUZZLE_WIDTH), this.MAX_PUZZLE_HEIGHT);
        /**this.pieceSpace = new Rectangle(0, this.boardSpace.bottom - 15, Math.max(this.canvas.width, this.MAX_PUZZLE_WIDTH), this.canvas.height);**/
        this.pieceSpace = new Rectangle(0, this.boardSpace.bottom - 15, Math.max(this.canvas.width, this.MAX_PUZZLE_WIDTH), this.canvas.height);
    },
